...
public class AdvancedSearchActivity extends BaseActivity implements OnDialogButtonClickListener {
    ...
    private void setUpViews(){
        ...
        selectCourseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AdvancedSearchActivity.this,SelectCourseActivity.class);
